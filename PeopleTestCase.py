...
driver.find_element_by_xpath("//a[text()='People']").click();
time.sleep(2);
try:
    elem = driver.find_element_by_xpath("//h1[text()='People']")
    if elem.is_displayed():
        elem.click();
        print("People homepage is displayed!")
except NoSuchElementException:
    print("People homepage is not displayed")
    print("Test Fail!!!!")
driver.close();
